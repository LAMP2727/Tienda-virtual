...
<body>
    <a href="carrito.php" data-id="<?php echo $data['id']; ?>" class="btn-flotante" id="btnCarrito">Carrito <span class="badge bg-success" id="carrito">0</span></a>
    <!-- Navigation-->
    <div class="container d-flex justify-content-center">
        <nav class="navbar navbar-expand-lg navbar-light " >
            <div class="container-fluid ">
                
            <a class="navbar-brand" href="login.php"><img src="img/logoo.png" width="200" alt="alternative"></a> 
    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            ...
            <a href=""> <img src="img/post2.png" width="100%" ></a> 
            </div>
        </div>
    </header>
    <section class="py-5">
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
                <?php
                $query = mysqli_query($conexion, "SELECT p.*, c.id AS id_cat, c.categoria FROM productos p INNER JOIN categorias c ON c.id = p.id_categoria WHERE cantidad > 0 ");
